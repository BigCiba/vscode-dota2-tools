...
const cmdGenerateDBCSV_1 = require("./command/cmdGenerateDBCSV");
...
async function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('dota2tools.generate_db_csv', () => (0, cmdGenerateDBCSV_1.GenerateDBCSV)(context)));
