...
const translateSelection_1 = require("./Command/translateSelection");
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let OpenKV = vscode.commands.registerCommand('dota2tools.OpenKV', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (text_editor !== undefined) {
                ...
                if (init_1.KV2LUA[word] !== undefined) {
                    ...
                    let rows = kv_string.split(os.EOL);
                    for (let i = 0; i < rows.length; i++) {
                        const line_text = rows[i];
                    ...
                    kv_string = fs.readFileSync(init_1.GameDir + '/scripts/npc/npc_items_custom.txt', 'utf-8');
                    kv_string = util.RemoveComment(kv_string);
        ...
        let CmdTranslateSelection = vscode.commands.registerCommand("dota2tools.translate_selection", translateSelection_1.TranslateSelection);
        // Lua API 相关
