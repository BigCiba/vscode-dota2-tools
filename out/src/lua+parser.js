...
function lua_load(chunk, chunkname) {
    ...
    eval("fn = function " + (chunkname || "load") + "() {\n" +
        "return (function () {\n" +
        exports.lua_parser.parse(chunk) + "\n" +
        "})()[0];\n" +
        "};");
    return fn;
}
/* Jison generated parser */
exports.lua_parser = (function () {
    var parser = {
            ...
            switch (yystate) {
                ...
                case 12:
                    ...
                    if ($$[$0 - 2].varfix_form || $$[$0 - 1].varfix_form) {
                        this.$.varfix_form = indentStatlist($$[$0 - 2].varfix_form || $$[$0 - 2].simple_form, $$[$0 - 1].varfix_form || $$[$0 - 1].simple_form);
                    }
                    break;
                case 13:
                    if ($$[$0].access) {
        ...
        lexer.performAction = function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
            ...
            switch ($avoiding_name_collisions) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    yy_.yytext = longStringToString(yy_.yytext);
                    return 57;
                    break;
                case 9:
                    return 43;
...
//# sourceMappingURL=lua+parser.js.map