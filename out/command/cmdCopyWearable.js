...
function copyWearable(context) {
    ...
    let zhCN = (0, kvUtils_1.readKeyValue2)(fs.readFileSync(path.join(context.extensionPath, "resource/items_schinese.txt"), 'utf-8'), false).lang.Tokens;
    ...
    inputBox.onDidAccept((t) => {
        ...
        console.log(result);
        vscode.env.clipboard.writeText((0, kvUtils_1.writeKeyValue)({ [inputBox.value]: result }, 2));
        inputBox.dispose();
    });
    function findBundle(itemName) {
...
exports.copyWearable = copyWearable;
//# sourceMappingURL=cmdCopyWearable.js.map