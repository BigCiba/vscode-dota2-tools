...
exports.createWearableItems = void 0;
 ...
 * @export
 */
function createWearableItems(context) {
    const gameDir = (0, addonInfo_1.getGameDir)();
    const contentDir = (0, addonInfo_1.getContentDir)();
    let localization = "";
    let itemsKV = {};
    let wearableKV = (0, kvUtils_1.readKeyValue2)(fs.readFileSync(path.join(gameDir, "scripts/npc/kv/wearable.kv"), 'utf-8')).Wearable;
    ...
    fs.writeFileSync(path.join(gameDir, "scripts/npc/kv/abilities/wearable_items.kv"), (0, kvUtils_1.writeKeyValue)({ KeyValue: itemsKV }));
    fs.writeFileSync(path.join(gameDir, "localization/schinese/abilities/wearable_items.txt"), localization);
}
exports.createWearableItems = createWearableItems;
function getVpcf(model) {
...
//# sourceMappingURL=cmdCreateWearableItems.js.map