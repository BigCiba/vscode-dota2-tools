...
---[[ CDOTA_BaseNPC_Hero:Script_ModifyGoldFiltered  Gives this hero some gold, using the gold filter if extra filtering is on.  Args: int nGoldChange, bool bReliable, int reason ]]
-- @return int
-- @param iGoldChange int
-- @param bReliabe bool
-- @param iReason int
