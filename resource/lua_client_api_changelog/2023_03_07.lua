...
MODIFIER_EVENT_ON_ASSIST = 233 -- OnAssist
...
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 247 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 178 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 236 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 177 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 174 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 244 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 175 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 254 -- OnAttemptProjectileDodge
...
MODIFIER_EVENT_ON_DOMINATED = 231 -- OnDominated
...
MODIFIER_EVENT_ON_KILL = 232 -- OnKill
...
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 255 -- OnPreDebuffApplied
...
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 245 -- OnProjectileObstructionHit
...
MODIFIER_PROPERTY_ABILITY_LAYOUT = 230 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 149 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 148 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 150 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 138 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 160 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 172 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 161 -- GetAllowEtherealAttack
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 253 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 250 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 122 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 38 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 107 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 108 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 110 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 109 -- GetModifierAttackRangeBonusUnique
...
MODIFIER_PROPERTY_BONUS_DAY_VISION = 141 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 142 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 143 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 144 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 249 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 164 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 165 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 238 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 121 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 103 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_PERCENTAGE = 104 -- GetModifierCastRangeBonusPercentage
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 106 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 105 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 227 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 119 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 120 -- GetModifierPercentageCooldownOngoing
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 256 -- GetModifierPercentageCooldownStacking
...
MODIFIER_PROPERTY_DEATHGOLDCOST = 125 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 140 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 159 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 225 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 167 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 242 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 62 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 126 -- GetModifierPercentageExpRateBoost
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 92 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 95 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 93 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_MANA_BONUS_PERCENTAGE = 94 -- GetModifierExtraManaBonusPercentage
MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 96 -- GetModifierExtraManaPercentage
...
MODIFIER_PROPERTY_FIXED_DAY_VISION = 145 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 146 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 224 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 127 -- GetModifierPercentageGoldRateBoost
...
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 226 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 237 -- GetModifierIgnoreCooldown
...
MODIFIER_PROPERTY_ILLUSION_LABEL = 152 -- GetModifierIllusionLabel
...
MODIFIER_PROPERTY_IS_ILLUSION = 151 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 216 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 217 -- GetModifierShard
MODIFIER_PROPERTY_KNOCKBACK_AMPLIFICATION_PERCENTAGE = 261 -- GetModifierKnockbackAmplification_Percentage
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 51 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 221 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 130 -- GetModifierMagical_ConstantBlock
...
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 123 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 124 -- GetModifierPercentageManacostStacking
...
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 111 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 169 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 147 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 69 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 213 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 214 -- GetModifierModelScale
MODIFIER_PROPERTY_MODEL_SCALE_ANIMATE_TIME = 215 -- GetModifierModelScaleAnimateTime
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 251 -- GetModifierMoveSpeedReductionPercentage
...
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 228 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 229 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 135 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 137 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 136 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 11 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 162 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 15 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICALDAMAGEOUTGOING_PERCENTAGE = 260 -- GetModifierPhysicalDamageOutgoing_Percentage
...
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 131 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 132 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 128 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 171 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 129 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 235 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 12 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 170 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_NAME = 114 -- GetModifierProjectileName
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 112 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 113 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 222 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 218 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_RAT_PACK = 259 -- GetModifierIsRatPack
MODIFIER_PROPERTY_REFLECT_SPELL = 139 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 115 -- ReincarnateTime
MODIFIER_PROPERTY_RESPAWNTIME = 116 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 117 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 118 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 223 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_SPELL_REDIRECT_TARGET = 257 -- GetModifierSpellRedirectTarget
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 98 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 101 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 99 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 102 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 97 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 100 -- GetModifierBonusStats_Strength_Percentage
...
MODIFIER_PROPERTY_STRONG_ILLUSION = 153 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 154 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 155 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 248 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 246 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 234 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 212 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 243 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 43 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 134 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 133 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 219 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 220 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 168 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_CONSTANT = 258 -- GetModifierTurnRateConstant
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 158 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 157 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 166 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 163 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 239 -- GetVisualZDelta
MODIFIER_PROPERTY_VISUAL_Z_SPEED_BASE_OVERRIDE = 240 -- GetVisualZSpeedBaseOverride
MODIFIER_PROPERTY_XP_DURING_DEATH = 156 -- GetModifierXPDuringDeath
