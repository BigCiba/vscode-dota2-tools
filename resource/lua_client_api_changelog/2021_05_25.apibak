...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 181 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 178 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 179 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 177 -- OnAbilityStart
MODIFIER_EVENT_ON_ATTACK = 170 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 190 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 173 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 236 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 172 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 226 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 171 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 168 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 233 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 169 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 243 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 180 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 202 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 189 -- OnDamageCalculated
MODIFIER_EVENT_ON_DEATH = 191 -- OnDeath
MODIFIER_EVENT_ON_DEATH_PREVENTED = 185 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 223 -- OnDominated
MODIFIER_EVENT_ON_HEALTH_GAINED = 197 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 201 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 200 -- OnHeroKilled
MODIFIER_EVENT_ON_MANA_GAINED = 198 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 203 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 204 -- OnModifierAdded
MODIFIER_EVENT_ON_ORB_EFFECT = 187 -- Unused
MODIFIER_EVENT_ON_ORDER = 175 -- OnOrder
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 188 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 182 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 174 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 234 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 183 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 192 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 196 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 167 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_MANA = 193 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 186 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 184 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 199 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 195 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 194 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 176 -- OnUnitMoved
MODIFIER_FUNCTION_INVALID = 255
MODIFIER_FUNCTION_LAST = 244
MODIFIER_PROPERTY_ABILITY_LAYOUT = 222 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 143 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 142 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 144 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 132 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 154 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 166 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 155 -- GetAllowEtherealAttack
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 242 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 239 -- GetModifierAttackSpeedReductionPercentage
...
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 241
...
MODIFIER_PROPERTY_BONUS_DAY_VISION = 135 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 136 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 137 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 138 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 238 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 158 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 159 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 228 -- GetModifierCanAttackTrees
...
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 219 -- GetModifierChangeAbilityValue
...
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 134 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 153 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 217 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 161 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 231 -- GetModifierNoVisionOfAttacker
...
MODIFIER_PROPERTY_FIXED_DAY_VISION = 139 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 140 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 216 -- GetForceDrawOnMinimap
...
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 218 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 227 -- GetModifierIgnoreCooldown
...
MODIFIER_PROPERTY_ILLUSION_LABEL = 146 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 230
...
MODIFIER_PROPERTY_IS_ILLUSION = 145 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 208 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 209 -- GetModifierShard
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 49 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 213 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 124 -- GetModifierMagical_ConstantBlock
...
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 163 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 141 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 67 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 206 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 207 -- GetModifierModelScale
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 240 -- GetModifierMoveSpeedReductionPercentage
...
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 220 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 221 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 129 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 131 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 130 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 10 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 156 -- GetOverrideAttackMagical
...
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 125 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 126 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 122 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 165 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 123 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 225 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 11 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 164 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 214 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 210 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REFLECT_SPELL = 133 -- GetReflectSpell
...
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 215 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_STRONG_ILLUSION = 147 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 148 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 149 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 237 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 235 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 224 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 205 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 232 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 42 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 128 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 127 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 211 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 212 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 162 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 152 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 151 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 160 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 157 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 229 -- GetVisualZDelta
MODIFIER_PROPERTY_XP_DURING_DEATH = 150 -- GetModifierXPDuringDeath
