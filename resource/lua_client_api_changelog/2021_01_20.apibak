...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 177 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 174 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 175 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 173 -- OnAbilityStart
MODIFIER_EVENT_ON_ATTACK = 166 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 186 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 169 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 232 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 168 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 222 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 167 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 164 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 229 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 165 -- OnAttackStart
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 176 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 198 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 185 -- OnDamageCalculated
MODIFIER_EVENT_ON_DEATH = 187 -- OnDeath
MODIFIER_EVENT_ON_DEATH_PREVENTED = 181 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 219 -- OnDominated
MODIFIER_EVENT_ON_HEALTH_GAINED = 193 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 197 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 196 -- OnHeroKilled
MODIFIER_EVENT_ON_MANA_GAINED = 194 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 199 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 200 -- OnModifierAdded
MODIFIER_EVENT_ON_ORB_EFFECT = 183 -- Unused
MODIFIER_EVENT_ON_ORDER = 171 -- OnOrder
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 184 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 178 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 170 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 230 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 179 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 188 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 192 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 163 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_MANA = 189 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 182 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 180 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 195 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 191 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 190 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 172 -- OnUnitMoved
MODIFIER_FUNCTION_INVALID = 255
MODIFIER_FUNCTION_LAST = 238
MODIFIER_PROPERTY_ABILITY_LAYOUT = 218 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 141 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 140 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 142 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 130 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 152 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 153 -- GetAllowEtherealAttack
...
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 235 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 115 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 35 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 100 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 101 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 103 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 102 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 237
MODIFIER_PROPERTY_AVOID_DAMAGE = 63 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_SPELL = 64 -- GetModifierAvoidSpell
...
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 53 -- GetModifierBaseDamageOutgoing_PercentageUnique
...
MODIFIER_PROPERTY_BASE_MANA_REGEN = 77 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 36 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 133 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 134 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 135 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 136 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 234 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 156 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 157 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 224 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 114 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 97 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 99 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 98 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 215 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 112 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 113 -- GetModifierPercentageCooldownOngoing
...
MODIFIER_PROPERTY_DEATHGOLDCOST = 118 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 132 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 151 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 213 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 159 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 227 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 58 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 119 -- GetModifierPercentageExpRateBoost
...
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 86 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 29 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 137 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 138 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 212 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_HEALTH_BONUS = 84 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 81 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 82 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 83 -- GetModifierHealthRegenPercentageUnique
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_SOURCE = 44 -- GetModifierHealAmplify_PercentageSource
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET = 45 -- GetModifierHealAmplify_PercentageTarget
MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE = 46 -- GetModifierHPRegenAmplify_Percentage
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 214 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 223 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_IGNORE_MOVESPEED_LIMIT = 26 -- GetModifierIgnoreMovespeedLimit
MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 71 -- GetModifierIgnorePhysicalArmor
MODIFIER_PROPERTY_ILLUSION_LABEL = 144 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 226
MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 54 -- GetModifierIncomingDamage_Percentage
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 56 -- GetModifierIncomingPhysicalDamageConstant
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 55 -- GetModifierIncomingPhysicalDamage_Percentage
MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 57 -- GetModifierIncomingSpellDamageConstant
...
MODIFIER_PROPERTY_IS_ILLUSION = 143 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 204 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 205 -- GetModifierShard
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 47 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 209 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 122 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 72 -- GetModifierMagicalResistanceBaseReduction
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 74 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 75 -- GetModifierMagicalResistanceBonusIllusions
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 76 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 73 -- GetModifierMagicalResistanceDirectModification
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 116 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 117 -- GetModifierPercentageManacostStacking
MODIFIER_PROPERTY_MANACOST_REDUCTION_CONSTANT = 32 -- GetModifierManacostReduction_Constant
MODIFIER_PROPERTY_MANA_BONUS = 85 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_DRAIN_AMPLIFY_PERCENTAGE = 50 -- GetModifierManaDrainAmplify_Percentage
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 78 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 79 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 80 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 104 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 161 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 139 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 65 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 202 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 203 -- GetModifierModelScale
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 236 -- GetModifierMoveSpeedReductionPercentage
MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE = 49 -- GetModifierMPRegenAmplify_Percentage
MODIFIER_PROPERTY_MP_RESTORE_AMPLIFY_PERCENTAGE = 51 -- GetModifierMPRestoreAmplify_Percentage
MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 59 -- GetModifierNegativeEvasion_Constant
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 216 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 217 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 127 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 129 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 128 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 9 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 154 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 13 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BASE_PERCENTAGE = 66 -- GetModifierPhysicalArmorBase_Percentage
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 68 -- GetModifierPhysicalArmorBonus
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 69 -- GetModifierPhysicalArmorBonusUnique
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 70 -- GetModifierPhysicalArmorBonusUniqueActive
MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 67 -- GetModifierPhysicalArmorTotal_Percentage
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 123 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 124 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 120 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 121 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 221 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 10 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 162 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_NAME = 107 -- GetModifierProjectileName
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 105 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 106 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 210 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 206 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REFLECT_SPELL = 131 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 108 -- ReincarnateTime
MODIFIER_PROPERTY_RESPAWNTIME = 109 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 110 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 111 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 211 -- GetModifierSpellsRequireHP
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE = 42 -- GetModifierSpellAmplify_Percentage
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_CREEP = 41 -- GetModifierSpellAmplify_PercentageCreep
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_UNIQUE = 43 -- GetModifierSpellAmplify_PercentageUnique
MODIFIER_PROPERTY_SPELL_LIFESTEAL_AMPLIFY_PERCENTAGE = 48 -- GetModifierSpellLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 92 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 95 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 93 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 96 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 91 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 94 -- GetModifierBonusStats_Strength_Percentage
MODIFIER_PROPERTY_STATUS_RESISTANCE = 60 -- GetModifierStatusResistance
MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER = 62 -- GetModifierStatusResistanceCaster
MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING = 61 -- GetModifierStatusResistanceStacking
MODIFIER_PROPERTY_STRONG_ILLUSION = 145 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 146 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 147 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 233 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 231 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 220 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 201 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 228 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 40 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 126 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 125 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 207 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 208 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 160 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 150 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 149 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 158 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 155 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 225 -- GetVisualZDelta
MODIFIER_PROPERTY_XP_DURING_DEATH = 148 -- GetModifierXPDuringDeath
