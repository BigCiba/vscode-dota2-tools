...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 180 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 177 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 178 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 176 -- OnAbilityStart
MODIFIER_EVENT_ON_ATTACK = 169 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 189 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 172 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 235 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 171 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 225 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 170 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 167 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 232 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 168 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 242 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 179 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 201 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 188 -- OnDamageCalculated
MODIFIER_EVENT_ON_DEATH = 190 -- OnDeath
MODIFIER_EVENT_ON_DEATH_PREVENTED = 184 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 222 -- OnDominated
MODIFIER_EVENT_ON_HEALTH_GAINED = 196 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 200 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 199 -- OnHeroKilled
MODIFIER_EVENT_ON_MANA_GAINED = 197 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 202 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 203 -- OnModifierAdded
MODIFIER_EVENT_ON_ORB_EFFECT = 186 -- Unused
MODIFIER_EVENT_ON_ORDER = 174 -- OnOrder
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 187 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 181 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 173 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 233 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 182 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 191 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 195 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 166 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_MANA = 192 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 185 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 183 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 198 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 194 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 193 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 175 -- OnUnitMoved
MODIFIER_FUNCTION_INVALID = 255
MODIFIER_FUNCTION_LAST = 243
MODIFIER_PROPERTY_ABILITY_LAYOUT = 221 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 142 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 141 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 143 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 131 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 153 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 165 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 154 -- GetAllowEtherealAttack
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 241 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 238 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 116 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 36 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 101 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 102 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 104 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 103 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 240
MODIFIER_PROPERTY_AVOID_DAMAGE = 64 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_SPELL = 65 -- GetModifierAvoidSpell
MODIFIER_PROPERTY_BASEATTACK_BONUSDAMAGE = 4 -- GetModifierBaseAttack_BonusDamage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 53 -- GetModifierBaseDamageOutgoing_Percentage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 54 -- GetModifierBaseDamageOutgoing_PercentageUnique
MODIFIER_PROPERTY_BASE_ATTACK_TIME_CONSTANT = 34 -- GetModifierBaseAttackTimeConstant
MODIFIER_PROPERTY_BASE_ATTACK_TIME_CONSTANT_ADJUST = 35 -- GetModifierBaseAttackTimeConstant_Adjust
MODIFIER_PROPERTY_BASE_MANA_REGEN = 78 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 37 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 134 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 135 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 136 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 137 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 237 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 157 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 158 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 227 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 115 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 98 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 100 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 99 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 218 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 113 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 114 -- GetModifierPercentageCooldownOngoing
MODIFIER_PROPERTY_COOLDOWN_REDUCTION_CONSTANT = 32 -- GetModifierCooldownReduction_Constant
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE = 38 -- GetModifierDamageOutgoing_Percentage
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_ILLUSION = 39 -- GetModifierDamageOutgoing_Percentage_Illusion
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_ILLUSION_AMPLIFY = 40 -- GetModifierDamageOutgoing_Percentage_Illusion_Amplify
MODIFIER_PROPERTY_DEATHGOLDCOST = 119 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 133 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 152 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 216 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 160 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 230 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 59 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 120 -- GetModifierPercentageExpRateBoost
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 88 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 90 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 89 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 91 -- GetModifierExtraManaPercentage
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 87 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 29 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 138 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 139 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 215 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_HEALTH_BONUS = 85 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 82 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 83 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 84 -- GetModifierHealthRegenPercentageUnique
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_SOURCE = 45 -- GetModifierHealAmplify_PercentageSource
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET = 46 -- GetModifierHealAmplify_PercentageTarget
MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE = 47 -- GetModifierHPRegenAmplify_Percentage
MODIFIER_PROPERTY_IGNORE_ATTACKSPEED_LIMIT = 31 -- GetModifierAttackSpeed_Limit
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 217 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 226 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_IGNORE_MOVESPEED_LIMIT = 26 -- GetModifierIgnoreMovespeedLimit
MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 72 -- GetModifierIgnorePhysicalArmor
MODIFIER_PROPERTY_ILLUSION_LABEL = 145 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 229
MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 55 -- GetModifierIncomingDamage_Percentage
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 57 -- GetModifierIncomingPhysicalDamageConstant
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 56 -- GetModifierIncomingPhysicalDamage_Percentage
MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 58 -- GetModifierIncomingSpellDamageConstant
...
MODIFIER_PROPERTY_IS_ILLUSION = 144 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 207 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 208 -- GetModifierShard
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 48 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 212 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 123 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 73 -- GetModifierMagicalResistanceBaseReduction
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 75 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 76 -- GetModifierMagicalResistanceBonusIllusions
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 77 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 74 -- GetModifierMagicalResistanceDirectModification
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 117 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 118 -- GetModifierPercentageManacostStacking
MODIFIER_PROPERTY_MANACOST_REDUCTION_CONSTANT = 33 -- GetModifierManacostReduction_Constant
MODIFIER_PROPERTY_MANA_BONUS = 86 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_DRAIN_AMPLIFY_PERCENTAGE = 51 -- GetModifierManaDrainAmplify_Percentage
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 79 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 80 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 81 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 105 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 162 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 140 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 66 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 205 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 206 -- GetModifierModelScale
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 239 -- GetModifierMoveSpeedReductionPercentage
MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE = 50 -- GetModifierMPRegenAmplify_Percentage
MODIFIER_PROPERTY_MP_RESTORE_AMPLIFY_PERCENTAGE = 52 -- GetModifierMPRestoreAmplify_Percentage
MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 60 -- GetModifierNegativeEvasion_Constant
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 219 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 220 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 128 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 130 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 129 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 9 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 155 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 13 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BASE_PERCENTAGE = 67 -- GetModifierPhysicalArmorBase_Percentage
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 69 -- GetModifierPhysicalArmorBonus
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 70 -- GetModifierPhysicalArmorBonusUnique
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 71 -- GetModifierPhysicalArmorBonusUniqueActive
MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 68 -- GetModifierPhysicalArmorTotal_Percentage
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 124 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 125 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 121 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 164 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 122 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 224 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 10 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 163 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_NAME = 108 -- GetModifierProjectileName
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 106 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 107 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 213 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 209 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REFLECT_SPELL = 132 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 109 -- ReincarnateTime
MODIFIER_PROPERTY_RESPAWNTIME = 110 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 111 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 112 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 214 -- GetModifierSpellsRequireHP
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE = 43 -- GetModifierSpellAmplify_Percentage
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_CREEP = 42 -- GetModifierSpellAmplify_PercentageCreep
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_UNIQUE = 44 -- GetModifierSpellAmplify_PercentageUnique
MODIFIER_PROPERTY_SPELL_LIFESTEAL_AMPLIFY_PERCENTAGE = 49 -- GetModifierSpellLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 93 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 96 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 94 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 97 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 92 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 95 -- GetModifierBonusStats_Strength_Percentage
MODIFIER_PROPERTY_STATUS_RESISTANCE = 61 -- GetModifierStatusResistance
MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER = 63 -- GetModifierStatusResistanceCaster
MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING = 62 -- GetModifierStatusResistanceStacking
MODIFIER_PROPERTY_STRONG_ILLUSION = 146 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 147 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 148 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 236 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 234 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 223 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 204 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 231 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 41 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 127 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 126 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 210 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 211 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 161 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 151 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 150 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 159 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 156 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 228 -- GetVisualZDelta
MODIFIER_PROPERTY_XP_DURING_DEATH = 149 -- GetModifierXPDuringDeath
