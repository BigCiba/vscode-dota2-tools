...
DOTA_HEROPICK_STATE_SCENARIO = 61
...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 183 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 180 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 181 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 179 -- OnAbilityStart
MODIFIER_EVENT_ON_ATTACK = 172 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 192 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 175 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 238 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 174 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 228 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 173 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 170 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 235 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 171 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 245 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 182 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 204 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 191 -- OnDamageCalculated
MODIFIER_EVENT_ON_DEATH = 193 -- OnDeath
MODIFIER_EVENT_ON_DEATH_PREVENTED = 187 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 225 -- OnDominated
MODIFIER_EVENT_ON_HEALTH_GAINED = 199 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 203 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 202 -- OnHeroKilled
MODIFIER_EVENT_ON_MANA_GAINED = 200 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 205 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 206 -- OnModifierAdded
MODIFIER_EVENT_ON_ORB_EFFECT = 189 -- Unused
MODIFIER_EVENT_ON_ORDER = 177 -- OnOrder
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 246 -- OnPreDebuffApplied
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 190 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 184 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 176 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 236 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 185 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 194 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 198 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 169 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_MANA = 195 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 188 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 186 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 201 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 197 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 196 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 178 -- OnUnitMoved
MODIFIER_FUNCTION_INVALID = 255
MODIFIER_FUNCTION_LAST = 248
MODIFIER_PROPERTY_ABILITY_LAYOUT = 224 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 145 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 144 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 146 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 134 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 156 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 168 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 157 -- GetAllowEtherealAttack
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 244 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 241 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 118 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 38 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 103 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 104 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 106 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 105 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 243
MODIFIER_PROPERTY_AVOID_DAMAGE = 66 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_SPELL = 67 -- GetModifierAvoidSpell
MODIFIER_PROPERTY_BASEATTACK_BONUSDAMAGE = 4 -- GetModifierBaseAttack_BonusDamage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 55 -- GetModifierBaseDamageOutgoing_Percentage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 56 -- GetModifierBaseDamageOutgoing_PercentageUnique
...
MODIFIER_PROPERTY_BASE_MANA_REGEN = 80 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 39 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 137 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 138 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 139 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 140 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 240 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 160 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 161 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 230 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 117 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 100 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 102 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 101 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 221 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 115 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 116 -- GetModifierPercentageCooldownOngoing
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 247 -- GetModifierPercentageCooldownStacking
...
MODIFIER_PROPERTY_DEATHGOLDCOST = 121 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 136 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 155 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 219 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 163 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 233 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 61 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 122 -- GetModifierPercentageExpRateBoost
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 90 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 92 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 91 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 93 -- GetModifierExtraManaPercentage
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 89 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 30 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 141 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 142 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 218 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 123 -- GetModifierPercentageGoldRateBoost
MODIFIER_PROPERTY_HEALTH_BONUS = 87 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 84 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 85 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 86 -- GetModifierHealthRegenPercentageUnique
...
MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE = 49 -- GetModifierHPRegenAmplify_Percentage
MODIFIER_PROPERTY_IGNORE_ATTACKSPEED_LIMIT = 32 -- GetModifierAttackSpeed_Limit
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 220 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 229 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_IGNORE_MOVESPEED_LIMIT = 27 -- GetModifierIgnoreMovespeedLimit
MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 74 -- GetModifierIgnorePhysicalArmor
MODIFIER_PROPERTY_ILLUSION_LABEL = 148 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 232
MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 57 -- GetModifierIncomingDamage_Percentage
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 59 -- GetModifierIncomingPhysicalDamageConstant
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 58 -- GetModifierIncomingPhysicalDamage_Percentage
MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 60 -- GetModifierIncomingSpellDamageConstant
...
MODIFIER_PROPERTY_IS_ILLUSION = 147 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 210 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 211 -- GetModifierShard
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 50 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 215 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 126 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 75 -- GetModifierMagicalResistanceBaseReduction
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 77 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 78 -- GetModifierMagicalResistanceBonusIllusions
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 79 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 76 -- GetModifierMagicalResistanceDirectModification
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 119 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 120 -- GetModifierPercentageManacostStacking
MODIFIER_PROPERTY_MANACOST_REDUCTION_CONSTANT = 34 -- GetModifierManacostReduction_Constant
MODIFIER_PROPERTY_MANA_BONUS = 88 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_DRAIN_AMPLIFY_PERCENTAGE = 53 -- GetModifierManaDrainAmplify_Percentage
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 81 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 82 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 83 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 107 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 165 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 143 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 68 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 208 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 209 -- GetModifierModelScale
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 242 -- GetModifierMoveSpeedReductionPercentage
MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE = 52 -- GetModifierMPRegenAmplify_Percentage
MODIFIER_PROPERTY_MP_RESTORE_AMPLIFY_PERCENTAGE = 54 -- GetModifierMPRestoreAmplify_Percentage
MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 62 -- GetModifierNegativeEvasion_Constant
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 222 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 223 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 131 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 133 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 132 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 10 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 158 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 14 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BASE_PERCENTAGE = 69 -- GetModifierPhysicalArmorBase_Percentage
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 71 -- GetModifierPhysicalArmorBonus
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 72 -- GetModifierPhysicalArmorBonusUnique
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 73 -- GetModifierPhysicalArmorBonusUniqueActive
MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 70 -- GetModifierPhysicalArmorTotal_Percentage
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 127 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 128 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 124 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 167 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 125 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 227 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 11 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 166 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 108 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 109 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 216 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 212 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REFLECT_SPELL = 135 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 111 -- ReincarnateTime
MODIFIER_PROPERTY_RESPAWNTIME = 112 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 113 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 114 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 217 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_SPELL_LIFESTEAL_AMPLIFY_PERCENTAGE = 51 -- GetModifierSpellLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 95 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 98 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 96 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 99 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 94 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 97 -- GetModifierBonusStats_Strength_Percentage
MODIFIER_PROPERTY_STATUS_RESISTANCE = 63 -- GetModifierStatusResistance
MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER = 65 -- GetModifierStatusResistanceCaster
MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING = 64 -- GetModifierStatusResistanceStacking
MODIFIER_PROPERTY_STRONG_ILLUSION = 149 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 150 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 151 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 239 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 237 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 226 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TOOLTIP = 207 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 234 -- OnTooltip2
...
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 129 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 213 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 214 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 164 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 154 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 153 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 162 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 159 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 231 -- GetVisualZDelta
MODIFIER_PROPERTY_XP_DURING_DEATH = 152 -- GetModifierXPDuringDeath
